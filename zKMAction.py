...
shift_without = {
    ...
    "'":0xDE,' ':0x20,'=':0xBB,
    'ㅂ':0x51,'ㅈ':0x57,'ㄷ':0x45,'ㄱ':0x52,'ㅅ':0x54,'ㅛ':0x59,'ㅕ':0x55,'ㅑ':0x49,'ㅐ':0x4F,'ㅔ':0x50,
    'ㅁ':0x41,'ㄴ':0x53,'ㅇ':0x44,'ㄹ':0x46,'ㅎ':0x47,'ㅗ':0x48,'ㅓ':0x4A,'ㅏ':0x4B,'ㅣ':0x4C,
    'ㅋ':0x5A,'ㅌ':0x58,'ㅊ':0x43,'ㅍ':0x56,'ㅠ':0x42,'ㅜ':0x4E,'ㅡ':0x4D,
}
...
shift_with = {
    ...
    '"':0xDE,' ':0x20,'+':0xBB,
    'ㅃ':0x51,'ㅉ':0x57,'ㄸ':0x45,'ㄲ':0x52,'ㅆ':0x54,'ㅒ':0x4F,'ㅖ':0x50,
}
...
def enter():
    ...
    win32api.keybd_event(0x0A,0,0,0)
